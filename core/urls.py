...
urlpatterns = [
    ...
    path("admin/classes/<int:classroom_id>/add-student/", views.admin_class_add_student, name="admin_class_add_student"),
    path("admin/classes/<int:classroom_id>/remove-student/<int:student_id>/", views.admin_class_remove_student, name="admin_class_remove_student"),
    ...
    path("teacher/materials/<int:material_id>/", views.teacher_material_detail, name="teacher_material_detail"),
    ...
    path("teacher/portfolios/", views.teacher_portfolio_list, name="teacher_portfolio_list"),
    path("teacher/portfolios/<int:student_id>/", views.teacher_student_portfolio, name="teacher_student_portfolio"),
    #submission testing
